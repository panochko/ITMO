...
public class Container<T extends AbstractCommand> implements Serializable {
    ...
    public Container(T command, Worker worker) {
    ...
    public static <T extends AbstractCommand> Container<T> withStringList(T command, List<String> list) {
        Container<T> container = new Container<>(command);
        container.list = list;
        return container;
    }
    public static <T extends AbstractCommand> Container<T> withIntegerList(T command, List<Integer> integerList) {
        Container<T> container = new Container<>(command);
