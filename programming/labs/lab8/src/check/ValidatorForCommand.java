...
public class ValidatorForCommand {
    public static int checkUpdate(Scanner scanner, Map<Integer, Worker> map){
        while (true) {
            ...
            if (input.trim().isEmpty()) {
                System.out.println(Color.RESET + "id не может быть пустым");
                continue;
            }
            try {
                return Integer.parseInt(input);
            } catch (NumberFormatException e) {
                System.out.println(Color.RESET + "доступные id: "+map.keySet());
            }
        }
    }
    public static String checkExecuteScript(Scanner scanner, Set<String> set) {
        while (true) {
            ...
            if (fileName.trim().isEmpty()){
                System.out.println(Color.RESET + "название скрипта не может быть пустым");
                continue;
            }
            try {
                ...
                System.out.println(Color.RESET + "нет такого скрипта");
            }
        }
    }
    public static String checkSave(Scanner scanner){
        while (true) {
            ...
            if (fileName.trim().isEmpty()){
                System.out.println(Color.RESET + "название файла не может быть пустым");
                continue;
            }
            try {
                ...
                System.out.println(Color.RESET + "файл для сохранения коллекции - FileWorker.json");
            }
        }
    }
    /**
    ...
    public static String checkNameAdd(String string) {
        try {
            ...
            System.out.println(Color.RESET + "имя может содержать только буквы. измените первое поле");
        }
        return null;
    }
    public static Integer checkFirstCoordinateAdd(String string) {
        try {
            ...
            System.out.println(Color.RESET + "первая координата может содержать только цифры. число должно быть целым. измените второе поле");
        }
        return null;
    }
    public static Float checkSecondCoordinateAdd(String string) {
        try {
            ...
            System.out.println(Color.RESET + "вторая координата может содержать только цифры и должна быть не больше 274. число должно быть дробным. измените третье поле");
        }
        return null;
    }
    public static Integer checkSalaryAdd(String string) {
        try {
            ...
            System.out.println(Color.RESET + "зарплата не может быть пустой и не должна быть меньше 0. число должно быть целым. измените четвертое поле");
        }
        return null;
    }
    ...
    public static Double checkWeightAdd(String string) {
        try {
            ...
            System.out.println(Color.RESET + "вес - дробное число. измените седьмое поле");
        }
        return null;
    }
    public static Integer checkFirstCoordinateOfLocationAdd(String string) {
        try {
            ...
            System.out.println(Color.RESET + "первая координата локации должна быть целым числом. измените восьмое поле");
        }
        return null;
    }
    public static Long checkSecondCoordinateOfLocationAdd(String string) {
        try {
            ...
            System.out.println(Color.RESET + "вторая координата локации должна быть целым числом. измените девятое поле");
        }
        return null;
    }
    public static Long checkThirdCoordinateOfLocationAdd(String string) {
        try {
            ...
            System.out.println(Color.RESET + "третья координата локации должна быть целым числом. измените десятое поле");
        }
        return null;
    }
    public static String checkNameOfLocationAdd(String string) {
        try {
            ...
            System.out.println(Color.RESET + "название локации может содержать только буквы. измените одиннадцатое поле");
        }
        return null;
    }
}
